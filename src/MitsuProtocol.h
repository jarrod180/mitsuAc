...
public:
	...
	void mode_tFromString (const char* mode, mode_t mode, bool success);
	...
	void fan_tFromString (const char* fan, fan_t fan, bool success);
	...
	void vane_tFromString (const char* vane, vane_t vane, bool success); 
	...
	void wideVane_tFromString (const char* wideVane, wideVane_t wideVane, bool success);
...
private:
	...
	convert from encoded byte to degrees Celsius.
	*/
